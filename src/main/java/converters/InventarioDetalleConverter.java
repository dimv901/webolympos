...
import controllers.InventarioDetalleFacade;
...
@FacesConverter(value = "inventarioDetalleConverter")
public class InventarioDetalleConverter implements Converter {

    @Inject
    private InventarioDetalleFacade ejbFacade;
