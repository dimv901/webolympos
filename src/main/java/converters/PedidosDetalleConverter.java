...
public class PedidosDetalleConverter implements Converter {
    ...
    @Inject
    private PedidosDetalleFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof PedidosDetalle) {
            PedidosDetalle o = (PedidosDetalle) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), PedidosDetalle.class.getName()});
            return null;
        }
    }
