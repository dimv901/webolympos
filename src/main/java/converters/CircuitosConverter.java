...
public class CircuitosConverter implements Converter {
    ...
    @Inject
    private CircuitosFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Circuitos) {
            Circuitos o = (Circuitos) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Circuitos.class.getName()});
            return null;
        }
    }
