...
public class StockConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            Logger.getLogger(StockConverter.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (ctx != null) {
            try {
                String lookupString;
                if (servletContext != null) {
                    lookupString = "java:global" + servletContext.getContextPath() + "/" + StockFacade.class.getSimpleName();
                } else {
                    lookupString = "java:global/" + StockFacade.class.getSimpleName();
                }
                ejbFacade = (StockFacade) ctx.lookup(lookupString);
            } catch (NamingException ex) {
                Logger.getLogger(StockConverter.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
