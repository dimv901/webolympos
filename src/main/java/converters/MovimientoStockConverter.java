...
import controllers.MovimientoStockFacade;
...
public class MovimientoStockConverter implements Converter {
    ...
    @Inject
    private MovimientoStockFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof MovimientoStock) {
            MovimientoStock o = (MovimientoStock) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), MovimientoStock.class.getName()});
            return null;
        }
    }
